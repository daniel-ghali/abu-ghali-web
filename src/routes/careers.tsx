    ...
    <>
      ...
      <Section>
        ...
        <div className="mt-12 overflow-hidden rounded-xl border border-hairline">
          {ROLES.map((r, i) => (
            <Reveal key={r.title} delay={i * 0.05} amount={0.1}>
              <div className={`grid gap-4 p-6 md:grid-cols-[2fr_1fr_1fr_auto] md:items-center md:p-8 ${i > 0 ? "border-t border-hairline" : ""}`}>
